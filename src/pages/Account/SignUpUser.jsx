  ...
  return (
    <>
      <div className="grid gap-4 sm:grid-cols-2">
        {/* welcome user */}
        <div className="min-h-[100vh] bg-gradient-to-br from-blue-300 via-blue-400 to-blue-500 flex  justify-center items-center text-white rounded-r-[32px] relative overflow-hidden">
          <div className="w-[73%] md:w-[60%] lg:w-[40%] flex flex-col  items-center ">
            ...
            {/* blue Circles */}
            <div className="absolute rounded-full bg-gradient-to-br from-blue-300 via-blue-300 to-blue-500 h-[180px] w-[180px] left-[-95px] top-[35px]"></div>
            <div className="absolute rounded-full bg-gradient-to-br from-blue-300 via-blue-400 to-blue-500 h-[63px] w-[63px] left-[175px] top-[165px]"></div>
            <div className="absolute rounded-full bg-gradient-to-r  from-blue-300 via-blue-400 to-blue-500  h-[80px] w-[80px] right-[100px] top-[55px]  "></div>
            <div className="absolute rounded-full bg-gradient-to-br from-blue-300 via-blue-400 to-blue-500 h-[73px] w-[73px] left-[95px] bottom-[150px]"></div>
            <div className="absolute rounded-full bg-gradient-to-br from-blue-300 via-blue-400 to-blue-500 h-[120px] w-[120px] right-[60px] top[170px]"></div>
            <div className="absolute rounded-full bg-gradient-to-br from-blue-300 via-blue-400 to-blue-500 h-[100px] w-[100px] right-[-50px] bottom-[80px] "></div>
            <div className="absolute rounded-full bg-gradient-to-br from-blue-300 via-blue-400 to-blue-500 h-[44px] w-[44px] right-[150px] bottom-[130px] "></div>
            <div className="absolute rounded-full bg-gradient-to-br from-blue-300 via-blue-400 to-blue-500 h-[150px] w-[150px] left-[-15px] bottom-[-30px]  "></div>
            {/* white circles */}
        ...
        >
          <div className="flex flex-col  ">
            ...
            <button
              type="submit"
              className=" text-center text-sm font-bold tracking-widest bg-main-yellow  border-none rounded-[10px] py-2  px-[30px] absolute -bottom-[-15%] -right-[-50%] translate-x-1/2 translate-y-1/2 "
            >
              CREATE
            </button>
          </div>
